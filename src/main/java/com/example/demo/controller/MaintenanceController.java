...
import com.example.demo.form.StoreRegistForm;
...
public class MaintenanceController {
	...
	private String showStoreForm(@ModelAttribute StoreRegistForm store) {
	...
	private String showStoreFormRet(@ModelAttribute StoreRegistForm store) {
	...
	public String registStore(
			@Validated @ModelAttribute StoreRegistForm store,
	...
	public String confirmRegistStore(
		...
		s.setCatchPhrase(form.getCatchCopy());
		service.regist(s);
